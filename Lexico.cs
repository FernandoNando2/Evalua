...
namespace Evalua{
    public class Lexico : Token{
        ...
        public Lexico()
        {
            ...
            log = new StreamWriter("C:\\Users\\Fernando Hernandez\\Desktop\\ITQ\\5to Semestre\\Lenguajes y Automatas II\\Evalua\\prueba.log");
            log.AutoFlush = true;
            log.WriteLine("Archivo: prueba.cpp");
            log.WriteLine("Compilado: " +hoy);
            if(File.Exists("C:\\Users\\Fernando Hernandez\\Desktop\\ITQ\\5to Semestre\\Lenguajes y Automatas II\\Evalua\\prueba.cpp")) // Investigar como checar si un archivo existe
                archivo = new StreamReader("C:\\Users\\Fernando Hernandez\\Desktop\\ITQ\\5to Semestre\\Lenguajes y Automatas II\\Evalua\\prueba.cpp"); 
            else
        ...
        {
            linea = 1;
            if(ruta == "C:\\Users\\Fernando Hernandez\\Desktop\\ITQ\\5to Semestre\\Lenguajes y Automatas II\\Evalua\\prueba.cpp")
                log = new StreamWriter("C:\\Users\\Fernando Hernandez\\Desktop\\ITQ\\5to Semestre\\Lenguajes y Automatas II\\Evalua\\prueba.log");
            else{
